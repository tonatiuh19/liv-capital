<?php
/**
 * POST /api/admin/model-upload.php
 * Authenticated. Accepts a single image file upload (multipart/form-data, field: "file").
 * Saves to public/uploads/models/ and returns { "url": "/uploads/models/filename.ext" }.
 *
...
// Ensure upload directory exists (public/uploads/models/)
$uploadDir = realpath(__DIR__ . '/../../') . '/uploads/models/';
if (!is_dir($uploadDir)) {
...
json_respond(['url' => '/uploads/models/' . $filename], 201);
