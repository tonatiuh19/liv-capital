<?php
/**
 * POST /api/admin/gallery-upload.php
 * Authenticated. Accepts a single image file (field: "file").
 * Saves to public/uploads/gallery/ and returns { "url": "..." }.
...
json_respond(['url' => '/uploads/gallery/' . $filename], 201);
