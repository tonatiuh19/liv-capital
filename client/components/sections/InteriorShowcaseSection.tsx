...
const interiors = [
  {
    name: "Sala de Estar",
    image: "🛋️",
    description: "Amplios espacios con ventanales que inundan de luz natural cada rincón",
  },
  {
    name: "Cocina Gourmet",
    image: "👨‍🍳",
    description: "Equipada con electrodomésticos de marca premium alemana e italiana",
  },
  {
    name: "Recámara Principal",
    image: "🛏️",
    description: "Suite máster con terrazas privadas y vistas panorámicas de la ciudad",
  },
  {
    name: "Baño Spa",
    image: "🚿",
    description: "Con acabados de lujo, productos de marca y sistemas de múltiples chorros",
  },
  {
    name: "Área de Trabajo",
    image: "💻",
    description: "Espacios dedicados con conectividad de fibra óptica ultra-rápida",
  },
  {
    name: "Terrazas Privadas",
    image: "🌿",
    description: "Espacios exteriores propios con vistas de la ciudad y zonas verdes",
  },
];
    ...
    <section className="py-20 md:py-32 px-6 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          className="mt-20 bg-gradient-to-r from-navy to-navy/90 text-white p-12 md:p-16 rounded-sm"
        >
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-stone-warm font-montserrat font-light leading-relaxed mb-8">
              Cada departamento en LIV CAPITAL está meticulosamente diseñado con los más altos estándares de lujo y funcionalidad. Desde la cocina gourmet hasta los baños tipo spa, cada espacio refleja nuestro compromiso con la excelencia.
            </p>
            <p className="text-lg text-stone-warm font-montserrat font-light leading-relaxed mb-8">
              Los interiores combinan materiales de procedencia internacional con una distribución inteligente que maximiza la luz natural y la ventilación. Cada unidad es un sanctuary donde forma y función se encuentran en perfecta armonía.
            </p>
